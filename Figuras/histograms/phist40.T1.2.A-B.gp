...
#set out "phist40.T1.2.A-B.eps"
#rep

#*************************** con Bezier **********************************
reset
set term x11
set out "phist40.T1.2.A-B.Bezier.eps"
set xrange [0:.85]

p '../../corrida40t6/Run.T1.2/hists/phistH2.51.dat' not smooth bezier w l lt 1 lw 5
rep '../../corrida40t6/Run.T1.2/hists/phistH2.45.dat' u 1:($2+(.09)) not smooth bezier w l lt 1 lw 5
rep '../../corrida40t6/Run.T1.2/hists/phistH2.39.dat' u 1:($2+(2*.09)) not smooth bezier w l lt 1 lw 5
rep '../../corrida40t6/Run.T1.2/hists/phistH2.33.dat' u 1:($2+(3*.09)) not smooth bezier w l lt 1 lw 5
rep 0 not lt 1, .09 not lt 1, 2*.09 not lt 1, 3*.09 not lt 1
...
set label 'H=2.51' at .69,.07
set label 'H=2.45' at .69,.16
set label 'H=2.39' at .69,.25
set label 'H=2.33' at .69,.34

set label "e)" at .02,.34
