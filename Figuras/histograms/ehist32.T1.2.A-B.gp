...
p '../../corrida32_transiciones_CIM/Run.A-B/ehist32.T1.2.H2.340' not w l lt 1 lw 6
rep '../../corrida32_transiciones_CIM/Run.A-B/ehist32.T1.2.H2.394' u 1:($2+(.025)) not w l lt 1 lw 6
rep '../../corrida32_transiciones_CIM/Run.A-B/ehist32.T1.2.H2.430' u 1:($2+(2*.025)) not w l lt 1 lw 6
rep '../../corrida32_transiciones_CIM/Run.A-B/ehist32.T1.2.H2.520' u 1:($2+(3*.025)) not w l lt 1 lw 6
rep 0 not, .025 not, 2*.025 not, 3*.025 not
...
set out "ehist32.T1.2.A-B.eps"
rep

#*************************** con Bezier **********************************
reset
set term x11
set out "ehist32.T1.2.A-B.Bezier.eps"
set xrange [-2.78:-2.5]
...
p '../../corrida32_transiciones_CIM/Run.A-B/ehist32.T1.2.H2.340' not smooth bezier w l lt 1 lw 5
rep '../../corrida32_transiciones_CIM/Run.A-B/ehist32.T1.2.H2.394' u 1:($2+(.1)) not smooth bezier w l lt 1 lw 5
rep '../../corrida32_transiciones_CIM/Run.A-B/ehist32.T1.2.H2.430' u 1:($2+(2*.1)) not smooth bezier w l lt 1 lw 5
rep '../../corrida32_transiciones_CIM/Run.A-B/ehist32.T1.2.H2.520' u 1:($2+(3*.1)) not smooth bezier w l lt 1 lw 5
...
set label 'H=2.520' at -2.56,.37
set label 'H=2.430' at -2.56,.27
set label 'H=2.394' at -2.56,.17
set label 'H=2.340' at -2.56,.07

set label "b)" at -2.76,.35
